 ...
 */
	[_COLEMAK] = LAYOUT_myr(
		...
		LAYERDOWN	, UNDO_X	, CUT_V		, COPY_C	, PASTE_D	, REDO_Q	, RALT_TABL	, TD_MOUSE	,	  KC_APP	, RALT_TAB	, KC_Z		, REPL_H	, KC_K		, KC_COMMA	, KC_DOT	, LAYERUP,
 ...
 */
	[_QWERTY] = LAYOUT_myr(
		...
		KC_CAPS		, KC_Q		, KC_W		, KC_E		, KC_R		, KC_T		,			  CK_PASTE	,	  CK_COPY	,			  KC_Y		, KC_U		, KC_I		, KC_O		, KC_P		, CW_TOGG,
		LYRCLR_ESC	, KC_A		, KC_S		, KC_D		, KC_F		, KC_G		,			  KC_NO		,	  KC_NO		,			  KC_H		, KC_J		, KC_K		, KC_L		, KC_QUOTE	, COLEMAK,
		LAYERDOWN	, KC_Z		, KC_X		, KC_C		, KC_V		, KC_B		, RALT_TABL, TD_MOUSE	,	  OS_LSG	, RALT_TAB	, KC_N		, KC_M		, KC_COMMA	, KC_DOT	, KC_SLASH	, LAYERUP,
 ...
 */
	[_GAME] = LAYOUT_myr(
		KC_F		, KC_F3		, KC_F5		, KC_F8		, KC_F11	, KC_F12	,			  KC_NO		,	  KC_NO		,			  KC_6		, KC_7		, KC_8		, KC_9		, KC_0		, KC_MINUS,
		KC_Q		, KC_1		, KC_2		, KC_3		, KC_4		, KC_5		,			  KC_TRNS	,	  KC_TRNS	,			  KC_Y		, KC_U		, KC_I		, KC_O		, KC_P		, KC_TRNS,
		KC_TRNS		, KC_A		, KC_S		, KC_W		, KC_D		, KC_E		,			  KC_NO		,	  KC_NO		,			  KC_H		, KC_J		, KC_K		, KC_L		, KC_QUOTE	, KC_TRNS,
		KC_TRNS		, KC_6		, KC_7		, KC_8		, KC_9		, KC_R		, KC_TAB	, KC_LGUI	,	  KC_TRNS	, KC_TRNS	, KC_1		, KC_2		, KC_3		, KC_4		, KC_5		, KC_TRNS,
